...
## 五、AMD Ryzen AI Max（Strix Halo / Gorgon Halo，PC 端统一内存）

> PC 平台上最接近 Mac 统一内存体验的方案，128GB 内存可跑 120B 模型

### 芯片系列

**当前代：Strix Halo（2025-2026）**

| 芯片 | CPU 核心 | GPU | 最大内存 | 说明 |
|------|---------|-----|---------|------|
| Ryzen AI Max+ 395 | 16 核 Zen 5 | 40CU Radeon 8060S | 128GB LPDDR5X-8000 | 旗舰，100 tok/s on Qwen3-30B |
| Ryzen AI Max+ 392 | 12 核 Zen 5 | 40CU Radeon 8060S | 128GB | CES 2026 新增 |
| Ryzen AI Max+ 388 | 8 核 Zen 5 | 40CU Radeon 8060S | 128GB | CES 2026 新增 |
| Ryzen AI Max 385 | 16 核 Zen 5 | 32CU | 128GB | 低一档 GPU |

**下一代：Gorgon Halo / Ryzen AI Max 400 系（Q4 2026 预期）**

| 芯片 | 改进 | 架构 |
|------|------|------|
| Ryzen AI Max+ 495（旗舰） | 睿频 5.2GHz（vs 395 的 5.1GHz），LPDDR5X-8533 内存 | Zen 5 + RDNA 3.5（刷新版，非全新） |

**真正下代：Medusa Halo（CES 2028 规划）：** Zen 6 + RDNA 5，目前无可购产品。

### Strix Halo 代表机型——Mini PC

| 型号 | 芯片 | 内存 | 价格 | 特点 |
|------|------|------|------|------|
| **AMD Ryzen AI Halo 开发者平台** | Ryzen AI Max+ 395 | 128GB | $3,999 | AMD 官方出品，2026/6 发布，Linux / Win11 Pro |
| **GMKtec EVO-X2** ⭐入门性价比 | Ryzen AI Max+ 395 | 64/128GB | $1,499 / $2,099 | Wi-Fi 7，USB4，2TB SSD |
| **Beelink GTR9 Pro** | Ryzen AI Max+ 395 | 128GB | $1,999 | 双 10GbE 网口，家庭服务器首选 |
| **ASRock AI BOX-A395** | Ryzen AI Max+ 395 | 128GB | ~$1,800 | 铝制紧凑机箱带提手 |
| **Minisforum AI A60** | Ryzen AI Max+ 395 | 64/128GB | $1,200-1,800 | 出货最早，生态最成熟 |

### Strix Halo 代表机型——笔记本

| 型号 | 芯片 | 内存 | 价格 | 特点 |
|------|------|------|------|------|
| **Asus ROG Flow Z13** | Ryzen AI Max+ 395 | 64/128GB | $2,499 | 平板变形本，128GB 对标 Mac Studio |
| **HP ZBook Ultra 14** | Ryzen AI Max+ 395 | 128GB | $3,000+ | 专业移动工作站，14 英寸 |
| **Asus Zenbook S 16** | Ryzen AI 9 HX（低功耗款） | 32/64GB | $1,499 | 轻薄本，50 TOPS NPU |
...
| Asus ROG Flow Z13 128GB | 128GB 统一 | 70B Q4 | $2,499 | 变形平板（Strix Halo） |
| AMD Ryzen AI Halo 官方 Mini PC | 128GB 统一 | 120B（同 Spark N1X 算力级） | $3,999 | 迷你主机（Strix Halo） |
| Beelink GTR9 Pro / ASRock AI BOX | 128GB 统一 | 120B | $1,800-2,099 | 迷你主机（Strix Halo） |
| RTX 5090 桌面 | 32GB VRAM | 70B Q4 | $3,500+ | 独显 |
| RTX 4090 桌面 | 24GB VRAM | 70B Q4 | $1,600+ | 独显 |
| GMKtec EVO-X2 128GB | 128GB 统一 | 120B | $2,099 | 迷你主机（Strix Halo） |
| Mac Mini M4 Pro 48GB | 48GB 统一 | 70B Q4 | $1,999 | 迷你主机 |
| NVIDIA RTX Spark N1 | 64GB 统一 | 70B Q4 | $2,000-2,500 | 笔记本/迷你主机 |
| GMKtec EVO-X2 64GB | 64GB 统一 | 70B Q4 | $1,499 | 迷你主机（Strix Halo） |
| RTX 5070 Ti / RX 7900 XTX | 16-24GB VRAM | 30B 流畅 | $750-1,600 | 独显 |
| HP ZBook Ultra 14（Strix Halo） | 128GB 统一 | 120B | $3,000+ | 专业笔记本 |
