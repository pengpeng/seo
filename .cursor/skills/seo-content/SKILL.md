...
1. **定关键词簇与文体**：从某份报告的「Top 关键词簇」取一个 ⭐⭐/⭐⭐⭐ 簇（1 簇 = 主词+次级+问题词 = 1 篇；选词标准见 [reference/keyword-selection-standard.md](/Users/pengpeng/seo/reference/keyword-selection-standard.md)），或用户直接给词。据主词词形选文体——**一篇覆盖整簇**，量小的次级/问题词进 H2/FAQ。
