...
- 具体型号词（qwen 3.6、glm 5.2、hidream 等）见 `directions/model/keywords.md`，适合做"在 Olares 上部署 X 模型"教程，抢新模型发布窗口。

**关联**：500 词分类 2（本地 LLM 45）、分类 13（AI 图像/视频/音频 30）；模型清单与报告见 [model/models.md](/Users/pengpeng/seo/directions/model/models.md) 与 [model/reports/](/Users/pengpeng/seo/directions/model/reports)（型号关键词底稿 `model/keywords.md`）；应用报告 [market/reports/](/Users/pengpeng/seo/directions/market/reports) 下 `comfyui.md`、`ollama.md`、`vllm.md`、`sglang.md`、`llamacpp.md`。
...
**对应 Olares 资产**：**Olares One**（x86 + NVIDIA CUDA 本地 AI 一体机）。关键规格见 [basic/olares.md](/Users/pengpeng/seo/basic/olares.md) 的 Olares One 一节（以 https://one.olares.com/ 为准）。
...
**关联**：500 词分类 9（AI 硬件 40）、分类 12（NAS/存储 30）；硬件竞品清单与报告见 [hardware/devices.md](/Users/pengpeng/seo/directions/hardware/devices.md) 与 [hardware/reports/](/Users/pengpeng/seo/directions/hardware/reports)（dgx、framework、beelink、minisforum、gmktec、asus、synology、qnap、unraid、truenas、casaos、umbrel、zimaos-zimacube 等约 34 份）。
