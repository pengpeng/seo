...
|--------|------|----|----|------|------|--------------------------|
| egpu | 9,900 | 42 | — | info | 次级 | 品类背景大词，OCuLink 话题引流 |
| aoostar wtr max | 1,000 | 20 | $0.27 | info | 次级 | "WTR Max vs Olares One"：存储盒 + eGPU TCO vs 一体机 24GB 独显 + Olares OS |
| oculink egpu | 1,000 | 18 | $0.30 | info | 主词候选 | "OCuLink eGPU 让 NAS 跑 AI 值不值"：补卡 TCO vs Olares One 开箱即用；已买走 B |
| aoostar wtr pro | 480 | 15 | — | comm | 次级 | 高价值信号型号词，内容可覆盖 |
| mini pc nas | 480 | 27 | $0.39 | info | 次级 | NAS mini PC 横评，Olares One 作本地 AI 侧 |
| aoostar nas | 390 | 28 | $0.24 | info | 主词候选 | "Aoostar NAS vs Olares One"：存储优先弱 iGPU vs AI 优先 24GB CUDA 独显 |
| wtr max | 320 | 5 | $4.11 | info | 主词候选 | KD5 + CPC$4.11 购买意向极强，弱 iGPU 跑不动本地大模型 vs Olares One 24GB 独显（有实测）|
| mini pc linux | 320 | 8 | $0.37 | info | 主词候选 | 信息 B：WTR Max（AMD 版）装 Olares 教程（ROCm + OCuLink eGPU）|
| ai nas | ~200 | — | — | info | 次级 | AI NAS 横评：弱算力存储盒 vs Olares One 独显本地 AI |
| mini pc server home | 170 | 8 | $0.47 | info | 次级 | 家庭服务器要不要能跑 AI，Olares One 全栈 |
| homelab mini pc | 70 | 14 | $0.60 | info | 次级 | homelab 场景词 |
| aoostar wtr max nas | 50 | 16 | $0 | info | 次级 | "WTR Max 装什么 NAS 系统"：Olares 私有云 OS，AMD 版借 ROCm 跑 AI |
| egpu nas | 0 | 0 | — | — | GEO | "NAS 靠 eGPU 跑 AI"前哨，抢 AI Overview |
| oculink nas | 0 | 0 | — | — | GEO | 零竞争新词前瞻 |
