...
- hardware 行级 ✅（82）> 唯一报告（48）：多 SKU 共享一份（Apple×4、UGREEN×2、极空间×2、Zima×2、MSI/HP/Lenovo/ROG-NUC/dGPU 型号族各多行）；`minisforum-nas` 为指向主报告的指针；`_archived/` 19 份旧品牌报告不计入。仅 Mac mini M5（未发布）待补。
...
> **P0 hardware 已清空**（本轮全部产出，含叙事纠偏 + benchmark 整合 + dGPU 组补跑）。仅剩 Mac mini M5（未发布，出货后补）。清单状态见 [devices.md](/Users/pengpeng/seo/directions/hardware/devices.md)。

| 目标 | 机会信号 |
|------|---------|
| ~~GMKtec EVO-X2~~ | ~~`gmktec evo-x2` 4,400/mo~~ ✅ [gmktec](/Users/pengpeng/seo/directions/hardware/reports/01-ai-soc/strix-halo/gmktec.md) |
| ~~Framework Desktop~~ | ~~Linux/Strix Halo 叙事~~ ✅ [framework](/Users/pengpeng/seo/directions/hardware/reports/01-ai-soc/strix-halo/framework.md) |
| ~~ROG NUC 16 (2026)~~ | ~~`olares one vs rog nuc`~~ ✅ [rog-nuc](/Users/pengpeng/seo/directions/hardware/reports/03-rog-nuc/rog-nuc.md) |
| ~~Legion Pro 7i Gen10~~ | ~~同 GPU、$3,999 对标 Olares One~~ ✅ [lenovo-legion](/Users/pengpeng/seo/directions/hardware/reports/02-5090-laptops/lenovo-legion.md) |
| ~~HP ZBook Ultra G1a~~ | ~~`strix halo laptop` KD9~~ ✅ [hp-strix-halo](/Users/pengpeng/seo/directions/hardware/reports/01-ai-soc/strix-halo/hp-strix-halo.md) |
| ~~Minisforum N5 Pro~~ | ~~AI NAS + OCuLink + 4090 实测~~ ✅ [minisforum](/Users/pengpeng/seo/directions/hardware/reports/01-ai-soc/strix-halo/minisforum.md) |
| ~~飞牛 fnOS~~ | ~~组八唯一缺报告 NAS OS~~ ✅ [fnos](/Users/pengpeng/seo/directions/hardware/reports/08-nas-os/fnos.md) |
| ~~ASUS Ascent GX10~~ | ~~`dgx spark alternative` 价位带~~ ✅ [asus-gb10](/Users/pengpeng/seo/directions/hardware/reports/01-ai-soc/gb10/asus-gb10.md) |
...
- **hardware**：产品级报告已基本清空（仅 Mac mini M5 未发布待补）；后续新机型上市随出随补，无常态长尾队列。
