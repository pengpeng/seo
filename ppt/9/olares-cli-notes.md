...
> 面向 Intel 合作 PPT 第 9 页的代码研究底稿。代码来源：`/Users/pengpeng/olares/cli`；快照日期：2026-07-15。
...
这些能力真实存在，但 npm / npx 的 remote-only 版本不注册它们。第 9 页若面向一般 Personal Agent，应以身份层能力为主，不把主机本地命令全部画进主控制链。
