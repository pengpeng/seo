...
> Intel 商业合作 Pitch 第 7 页的合并底稿。吸收原第 19 页 Files/Storage 与第 20 页 Network 研究；快照日期：2026-07-15。
...
主 Slide 使用三列，每列采用 Slide 8 的文案结构：**能力标题 + 粗体引导句 + 1–2 句解释**，不单列 Agent delegation。
...
这些事项不影响第 7 页的 Pitch 主线，但正式产品文档或交付承诺前应按目标版本核对。
