...
> 对外合作 PPT 第 11 页（Olares × Intel 章节开篇 / 硬件路线地图）。
...
- 第 11 页只画硬件路线地图，不重复第 12 页 B70 跑分、第 13 页会议市场数字或 Olares One benchmark。
- 主画面不再解释 Olares 的作用，不放平台能力条或总结段落；标题、副标题和三行路线完成过渡。
- 当前三路对应：
  - 第 12 页：Intel Box / NAS + Intel Arc Pro B70。
  - 第 13 页：Panther Lake SoC 独立运行。
...
- Arc Pro B70 是 160–290W 的 PCIe 工作站卡，属于第 12 页外置加速设备路线，不适合直接作为这条板载加速器路线的板载器件。
