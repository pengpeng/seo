...
> 底座认知见 [basic/olares.md](/Users/pengpeng/seo/basic/olares.md)；内容方法论＝seo-content skill（产出落 [content/](/Users/pengpeng/seo/content/README.md)）已就位；跨报告可执行 backlog（brand/topic-seo 待跑总队列 + 优先级）见 [directions/backlog.md](/Users/pengpeng/seo/directions/backlog.md)。
...
- 开源模型清单 + 每模态调研 + 逐型号报告 → [model/models.md](/Users/pengpeng/seo/directions/model/models.md)（当前 10 章收录 72 family，只收开源可本地跑的 2026 near-SOTA 型号；11-omni 待补）、[model/research/](/Users/pengpeng/seo/directions/model/research) 调研底稿与 [model/reports/](/Users/pengpeng/seo/directions/model/reports)（research/reports 两级、11 章：01-llm…11-omni）
- 商业付费 AI/SaaS 竞品清单 + 报告 → [commerce/products.md](/Users/pengpeng/seo/directions/commerce/products.md)（约 235 项/5 大类 57 细类，含 ✅ ~42 已调研 + ⬜ 待调研；`reports/` 另含 appendix 与平替侧报告，文件数 > ✅ 行）与 [commerce/reports/](/Users/pengpeng/seo/directions/commerce/reports)
...
- 隐私/安全竞品清单 + 报告 → [privacy/services.md](/Users/pengpeng/seo/directions/privacy/services.md)（隐私产品竞品**总索引**：核心品类 10 份自有报告 + 跨 commerce/market/tech 指针引用，不重复登记）与 [privacy/reports/](/Users/pengpeng/seo/directions/privacy/reports)；隐私**格局**分类总图（合规/认证/泄露/AI/巨头/概念/企业，7 大类约 39 子方向）+ 6 份 deep-research → [privacy/landscape.md](/Users/pengpeng/seo/directions/privacy/landscape.md) 与 [privacy/research/](/Users/pengpeng/seo/directions/privacy/research)
- 基础设施分类总表（方向 6，长尾/非主推）→ [tech/tech-stack.md](/Users/pengpeng/seo/directions/tech/tech-stack.md)：**扁平 11 大类**（计算/编排、存储、网络接入、数据库中间件、消息流、可观测、平台中间件、企业大数据、身份安全〈含密钥/HSM、授权 ReBAC〉、CI-CD、AI 基础设施〈含 Agent 沙盒、Agent 记忆、可观测评估、微调〉；IaaS/PaaS 只作视角），**每项目一行**给「介绍/许可/其它/公有云替代/Olares 状态/SEO 报告」，KubeBlocks 托管标 KB（以[官方 supported-addons](https://kubeblocks.io/docs/preview/user_docs/overview/supported-addons) 校正）；底稿 [tech/research/](/Users/pengpeng/seo/directions/tech/research)（索引 README + middleware-taxonomy/cloud-infra-taxonomy/ai-infra 三底稿 + 二轮核实来源），报告 [tech/reports/](/Users/pengpeng/seo/directions/tech/reports)（按 11 大类子目录：headscale→03-network/mesh-vpn、frp→03-network/reverse-proxy）。中间件锚点＝Olares 平台层由 KubeBlocks operator 托管、OlaresManifest 声明式依赖。向量库/Embedding/推理API/数据库中间件已从 commerce 迁入此处（GPU 算力云仍留 commerce）；商业方 Tailscale/Ngrok 归 commerce。
...
- **选词标准** → [reference/keyword-selection-standard.md](/Users/pengpeng/seo/reference/keyword-selection-standard.md)：两层——**报告层**三角色选词（主词候选/次级/GEO，产出"Top 关键词含角色判断"词表，主词软参考线 US≥~100）；**内容层**关键词簇＝seo-content 写文时的跨报告选题单位（1 簇=1 篇，落 front-matter，不建独立文件）。研究/内容 skill 均以此为单一事实源。
