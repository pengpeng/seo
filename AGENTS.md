...
- **选词标准** → [reference/keyword-selection-standard.md](/Users/pengpeng/seo/reference/keyword-selection-standard.md)：三角色选词（主词/次级/GEO）+ 主词软参考线 US≥~100 + 关键词簇=文章单位。研究/内容 skill 的选词与"Top 关键词簇"均以此为单一事实源。
